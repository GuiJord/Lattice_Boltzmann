...
title = ''#'Rattle effect (exponential) - '
legend_cmd = False
...
for i in range(n_profiles):
    plt.plot(y_coord,T[i,:],label=f'no rattle {i}',color=colors[i],ls='-',zorder=3)
...
plt.savefig('temperature_profile.png',dpi=100, bbox_inches='tight', pad_inches=0.25)
