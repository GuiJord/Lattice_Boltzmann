...
for file in $folder/*.dat; do
    ...
    output_file="${file%.dat}_concentration.png"

    gnuplot -e "input_file='${file}'; output_file='${output_file}'; nx=$nx; ny=$ny" gnuplot_files/concentration.plt
    i=$((i+1))
...
mkdir $folder/plot_concentration

mv $folder/*concentration.png $folder/plot_concentration